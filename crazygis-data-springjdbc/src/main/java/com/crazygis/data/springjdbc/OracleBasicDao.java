...
import com.crazygis.data.page.OraclePageCommand;
 ...
 */
public class OracleBasicDao implements IBasicDao {

    private JdbcTemplate jdbcTemplate;
    private NamedParameterJdbcTemplate namedParameterJdbcTemplate;
    private OraclePageCommand pageCommand;

    public OracleBasicDao() {
        pageCommand = new OraclePageCommand();
    }
